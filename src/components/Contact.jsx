...
export default function ContactSection() {
  ...
  return (
    <div className="bg-gradient-to-r from-[rgba(4,81,97,0.5)] via-[rgba(4,81,97,0.3)] to-[rgba(4,81,97,0)] p-2 lg:p-12 sm:flex sm:justify-between">
      {/* Contact Info Section */}
      <div className="bg-transparent p-2 lg:p-12 sm:p-4  sm:p-4 sm:w-1/2 flex flex-col justify-between">
